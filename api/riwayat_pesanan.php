...
function cekRute() {
    ...
    if(kota === "") {
        alert("Harap isi Kota/Kabupaten asal!");
        return;
    }
    ...
    // Logika Rekomendasi Cepat vs Murah
    if(kota === "probolinggo" || kota === "pasuruan") {
        rekomendasi = `
            <div class="mb-2"><b>⚡ Paling Cepat:</b> Motor (Langsung ke area Wonokitri/Cemoro Lawang).</div>
            <div><b>💰 Paling Murah:</b> Motor Pribadi (Hanya perlu bensin & parkir).</div>`;
    } 
    else if(kota === "malang") {
        rekomendasi = `
            <div class="mb-2"><b>⚡ Paling Cepat:</b> Mobil Pribadi/Ojek via Tumpang (Rute Jemplang).</div>
            <div><b>💰 Paling Murah:</b> Motor (Rute Tumpang lebih hemat waktu dan BBM).</div>`;
    }
    else if(kota === "surabaya" || kota === "sidoarjo") {
        rekomendasi = `
            <div class="mb-2"><b>⚡ Paling Cepat:</b> Mobil via Tol Paspro (Keluar Exit Tongas/Probolinggo).</div>
            <div><b>💰 Paling Murah:</b> Kereta Api Lokal (Surabaya - Pasuruan/Probolinggo) lanjut sewa motor.</div>`;
    }
    else if(kota === "jakarta" || kota === "bandung" || kota === "jogja") {
        rekomendasi = `
            <div class="mb-2"><b>⚡ Paling Cepat:</b> Pesawat (Landing Malang/Surabaya) lanjut Travel/Taxi.</div>
            <div><b>💰 Paling Murah:</b> Kereta Api Ekonomi (Turun Stasiun Malang/Probolinggo).</div>`;
    }
    else {
        rekomendasi = `
            <div class="mb-2"><b>⚡ Paling Cepat:</b> Gunakan Travel Door-to-Door agar langsung sampai titik kumpul.</div>
            <div><b>💰 Paling Murah:</b> Bus Antar Kota lanjut Angkutan Lokal (Elf) ke arah Bromo.</div>`;
    }

    teks.innerHTML = rekomendasi;
}
</script>
</body>
</html>